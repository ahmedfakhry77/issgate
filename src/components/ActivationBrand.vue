<template>
  <div>
    <Modal>
      ...
      >
        <h1
          class="text-3xl font-bold text-center my-2 py-4 mx-auto capitalize bg-secondary text-white"
        >
          Chang Brand Status
        </h1>
        <div class="mx-auto px-5">
          <form>
            <div class="grid grid-cols-2 gap-2">
              <div
                class="w-full min-w-full text-center col-span-2 text-primary py-8"
              >
